...
export CUSTOMIZED_REMOTE_OPENAI_API_KEY="sk-xxxxxxx" # the inference script is running while evaluation. Please make sure the endpoint and api key are correct.
...
python test_benchmark.py \
    ...
    --regen \
    --num_threads "$num_threads" 2>&1 | tee ../logs/inference_blink_qwen25vl3b_$task_name$cot_suffix.log